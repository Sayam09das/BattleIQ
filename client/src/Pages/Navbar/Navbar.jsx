            ...
            sections: [
                {
                    ...
                    icon: Calendar,
                    items: [
                        { name: "Daily Quiz", icon: Target, desc: "Test yourself every day", href: "/quests/daily-quiz" },
                        { name: "Time Trials", icon: Clock, desc: "Beat the clock in quizzes", href: "/quests/time-trials" },
                        { name: "Weekly Tournament", icon: Trophy, desc: "Compete for leaderboard glory", href: "/quests/weekly-tournament" },
                    ],
                },
                {
                    ...
                    icon: Star,
                    items: [
                        { name: "Seasonal Battles", icon: Zap, desc: "Limited-time quiz events", href: "/quests/seasonal-battles" },
                        { name: "Global Tournaments", icon: Globe, desc: "Challenge players worldwide", href: "/quests/global-tournaments" },
                    ],
                },
            ],
        },
            ...
            sections: [
                {
                    ...
                    icon: Brain,
                    items: [
                        { name: "AI Quiz Generator", icon: Cpu, desc: "Create quizzes instantly", href: "/learning/ai-generator" },
                        { name: "Performance Insights", icon: BarChart3, desc: "Analyze your results", href: "/learning/performance" },
                        { name: "Skill Builder", icon: Lightbulb, desc: "Get AI suggestions to improve", href: "/learning/skill-builder" },
                    ],
                },
                {
                    header: "Resources",
                    icon: BookOpen,
                    items: [
                        { name: "Quiz Library", icon: BookOpen, desc: "Thousands of ready quizzes", href: "/learning/resources/quiz-library" },
                        { name: "Tutorials", icon: Video, desc: "Step-by-step guides", href: "/learning/resources/tutorials" },
                        { name: "Certifications", icon: BadgeCheck, desc: "Earn official certificates", href: "/learning/resources/certifications" },
                    ],
                },
            ],
        },
            ...
            sections: [
                {
                    ...
                    icon: Users,
                    items: [
                        { name: "Forums", icon: MessageSquare, desc: "Join discussions with other learners", href: "/community/forums" },
                        { name: "Friends & Teams", icon: UserPlus, desc: "Team up for group battles", href: "/community/teams" },
                        { name: "Events & Meetups", icon: Calendar, desc: "Participate in online & offline events", href: "/community/events" },
                    ],
                },
                {
                    header: "Showcase",
                    icon: Trophy,
                    items: [
                        { name: "Leaderboards", icon: Trophy, desc: "See top players globally", href: "/community/leaderboard" },
                        { name: "Achievements", icon: Award, desc: "View badges and accomplishments", href: "/community/achievements" },
                    ],
                },
            ],
        },
