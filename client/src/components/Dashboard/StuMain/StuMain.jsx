...
const UserAvatar = ({ name = "Sayam Das", email = "SayamDas@gmail.com", imgSrc }) => {
    ...
    return (
        <Link to="/profile" className="relative group">
            ...
            {/* Tooltip with email */}
            <span
                className="absolute top-2/50 -translate-y-1/2 -left-24 text-xs bg-[#3B132A] text-[#F3EFDA] px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300"
            >
                {email}
            </span>
            ...
            >
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col gap-1">
                        <h2 className="text-2xl font-bold">{getGreeting()}, Alex! 👋</h2>
                        <WordRotate words={animatedTexts} duration={3000} className="text-sm opacity-70" />
                    </div>
                </div>
